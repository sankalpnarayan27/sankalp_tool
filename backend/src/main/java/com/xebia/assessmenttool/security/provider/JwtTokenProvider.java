package com.xebia.assessmenttool.security.provider;
...
public class JwtTokenProvider {
    ...
    public boolean isTokenPresentInDB(String token) {
        return jwtTokenRepository.isPresent(token);
    }
    ...
    public UserDetails getUserDetails(String token) {
        ...
        UserDetails userDetails = new RepositoryUserDetails(userName, roleList.toArray(new String[roleList.size()]));
        return userDetails;
    }
    ...
    public Authentication getAuthentication(String token) {
        ...
        //RepositoryUserDetails userDetails = userDetailsService.loadUserByUsername(getUsername(token));
